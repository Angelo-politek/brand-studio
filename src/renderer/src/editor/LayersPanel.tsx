...
export default function LayersPanel(): JSX.Element {
  ...
  const { layers, selectedIds, select, toggleSelect, updateLayer, removeLayer, duplicateLayer, moveLayer } =
    useStore()
  ...
  return (
    <div className="flex flex-col min-h-0">
      <div className="px-3 py-2 text-xs font-medium text-ink-muted border-b border-line">Layers</div>
